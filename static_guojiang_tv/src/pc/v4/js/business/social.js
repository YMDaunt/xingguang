 ...
 * @LastEditors: Jesse
 * @LastEditTime: 2019-08-30 17:30:39
 */
/* eslint-disable */
import '../../css/business/social.less'
import Vue from 'vue'
import bodymovin from '../component/bodymovin.min.js'

// 公共头部导航
import socialHeader from '../component/header/social.vue'
import socialFooter from '../component/footer/social.vue'
...
let vm = new Vue({
    ...
    methods: {
        ...
        startVoice (id) {
            if (!this.has_flash()) {
                location.href = '//www.adobe.com/go/getflashplayer_cn'
                return
            }
            ...
            var flashvars = {
                f: `${location.protocol}//static.guojiang.tv/src/pc/v4/img/chat/voice/${id}.${this.voiceArr[id - 1]['ext']}`,
                c: 0,
                p: 1
            }
        ...
        getContentAvatar (id) {
            return `//static.guojiang.tv/src/pc/v4/img/chat/avatar/(${id}).jpg`
        },

        getSideAvatar (id) {
            return `//static.guojiang.tv/src/pc/v4/img/chat/avatar/(${62 + id}).jpg`
        },

        getSideMaskImg (id) {
            return `//static.guojiang.tv/src/pc/v4/img/chat/0${id}.png`
        },
        ...
        getUserConnectAvatar () {
            function run () {
                ...
                vm.uConnectAvatar = `//static.guojiang.tv/src/pc/v4/img/chat/user/${num}.jpg`

                vm.mConnectAvatar = `//static.guojiang.tv/src/pc/v4/img/chat/avatar/(${num + 62}).jpg`
            }
            run()
