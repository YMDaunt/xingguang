...
$(document).ready(function () {
    $('.rules-main').niceScroll({
        cursorwidth: 8,
        cursorcolor: 'rgba(0, 0, 0, .6)', // 设置滚动条滑块的颜色
        cursorborder: 'none', // CSS方式定义滚动条边框颜色
        autohidemode: false,
        cursorfixedheight: 60,
        horizrailenabled: false,
        hwacceleration: true,
        railpadding: { top: 30, right: 21, left: 0, bottom: 0 }
    })

    // $(".user-l-main").niceScroll({
    //     cursorwidth: 8,
    //     cursorcolor: "rgba(71, 86, 168, .9)",//设置滚动条滑块的颜色
    //     cursorborder: "none", // CSS方式定义滚动条边框颜色
    //     autohidemode: false,
    //     cursorfixedheight: 60,
    //     horizrailenabled: false,
