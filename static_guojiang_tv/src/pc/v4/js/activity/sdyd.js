...
if (os.isPhone) location.href = 'https://m.kuaishouvideo.com/dist/activity/sdyd.html'
...
new Vue({
    ...
    methods: {
        ...
        doSdSvg1 () {
            this.svgPlayer = !this.svgPlayer
            playSvg('//static.guojiang.tv/src/pc/svg/activity/sdyd/sd/sd_1/data.json')
        },
        doSdSvg2 () {
            this.svgPlayer = !this.svgPlayer
            playSvg('//static.guojiang.tv/src/pc/svg/activity/sdyd/sd/sd_2/data.json')
        },
        doYdSvg1 () {
            this.svgPlayer = !this.svgPlayer
            playSvg('//static.guojiang.tv/src/pc/svg/activity/sdyd/yd/yd_1/data.json')
        },
        doYdSvg2 () {
            this.svgPlayer = !this.svgPlayer
            playSvg('//static.guojiang.tv/src/pc/svg/activity/sdyd/yd/yd_2/data.json')
        },
