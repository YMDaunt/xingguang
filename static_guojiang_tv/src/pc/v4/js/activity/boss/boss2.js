require('../../../css/activity/boss/boss2.less')
    ...
    methods: {
        ...
        attack () {
            ...
            this.getTrackInfo(() => {
                ...
                newWin.location = '/' + this.trackInfo.mid
            })
        },
        popup (bool) {
            if (bool) {
                this.showRules = true
                document.getElementsByTagName('html')[0].style.cssText += 'height:100%;margin-right:18px;overflow-y:hidden;'
                ...
                document.getElementsByTagName('html')[0].style.cssText += 'height:auto;margin-right:0;overflow-y:auto;'
