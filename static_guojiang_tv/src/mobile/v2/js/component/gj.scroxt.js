 ...
 */
            function addStyleCSS (cssText) {
                var style = document.createElement('style'); var head = document.head || document.getElementsByTagName('head')[0]
                style.type = 'text/css'
                if (style.styleSheet) {
                    var func = function () {
                        try {
 ...
 */
            var root = /** @class */ (function () {
                function root (_a) {
                    var target = _a.target; var data = _a.data; var speed = _a.speed
                    /**
         * [options 构造函数参数]
         * @type {Options}
         */
 ...
 */
            var Horizontal = /** @class */ (function (_super) {
                ...
                function Horizontal (_a) {
                    var target = _a.target; var data = _a.data; var speed = _a.speed; var _b = _a.gap; var gap = _b === void 0 ? 10 : _b
 ...
 */
            var Barrage = /** @class */ (function (_super) {
                ...
                function Barrage (_a) {
                    var video = _a.video; var dataTime = _a.dataTime
 ...
 */
            var Live = /** @class */ (function () {
                function Live (_a) {
                    var target = _a.target; var _b = _a.strongLock; var strongLock = _b === void 0 ? false : _b
                    /**
        * [barrage 弹幕]
        * @type {Array}
        */
     ...
     */
                Live.prototype.addBarrage = function (data, self) {
                    ...
                    if (self) { this.selfBarrage.push(data) } else { this.barrage.push(data) }
                }
                /**
     * [createBarrage 创建弹幕from readyShowBarrage]
     */
