...
if(os.isPc) location.href="//www.kuaishouvideo.com/activity/nationalDay.html";
    ...
    methods:{
        ...
        sign() {
            if (!this.uid) {
                ...
                if (!this.siginingJudge) {
                    this.siginingJudge = true;
                    ...
                    .then(res => {
                        ...
                        this.siginingJudge = false;
                        console.log(this.siginingJudge);
                    })
                    .catch(err => {
                        console.log(err)
                    })
