...
new Vue({
    ...
    methods: {
        ...
        preview (item) {
            ...
            // 皮皮虾典藏
            case '17':
                svgSrc = '//static.guojiang.tv/pc/v3/img/room/svg/mount/17/data.json'
                break
                // 皮皮虾标准
            case '16':
                svgSrc = '//static.guojiang.tv/pc/v3/img/room/svg/mount/16/data.json'
                break
                // 战斗机
            case '14':
                svgSrc = '//static.guojiang.tv/pc/v3/img/room/svg/mount/14/data.json'
                break
                // 圣诞快车
            case '15':
                svgSrc = '//static.guojiang.tv/pc/v3/img/room/svg/mount/15/data.json'
                break
                // 雪橇
            case '13':
                svgSrc = '//static.guojiang.tv/pc/v3/img/room/svg/mount/13/data.json'
                break
                // 雷麒麟
            case '10':
                svgSrc = '//static.guojiang.tv/pc/v3/img/room/svg/mount/10/data.json'
                break
                // 筋斗云
            case '9':
                svgSrc = '//static.guojiang.tv/pc/v3/img/room/svg/mount/9/data.json'
                break
                // 比翼鸟
            case '11':
                svgSrc = '//static.guojiang.tv/pc/v3/img/room/svg/mount/11/data.json'
                break

                // 旺财
            case '661':
                svgSrc = '//static.guojiang.tv/app/gift/pc_animation/661/661.json'
                break
                // 姜饼屋
            case '621':
                svgSrc = '//static.guojiang.tv/app/gift/pc_animation/621/621.json'
                break
                // 雪人派对
            case '622':
                svgSrc = '//static.guojiang.tv/app/gift/pc_animation/622/622.json'
                break
                // 捣蛋女巫
            case '427':
                svgSrc = '//static.guojiang.tv/app/gift/pc_animation/427/427_1508297715.json'
                break
                // 百鬼夜行
            case '428':
                svgSrc = '//static.guojiang.tv/app/gift/pc_animation/428/428_1508297714.json'
                break
                // 强势围观
            case '501':
                svgSrc = '//static.guojiang.tv/app/gift/pc_animation/501/501_1600000000.json'
                break
            }
            this.playSvg(svgSrc)
            this.smash = true
