...
require('../../css/activity/worldCup2.less')
...
if (os.isPc) location.href = '//www.kuaishouvideo.com/activity/worldCup2.html'
var timer = null
        ...
        axios.get('/WorldCup/init')
            .then(res => {
                ...
                if (this.stage == 3) {
                    ...
                    this.dataTime = '计数周期：7月10日12:00:00-7月15日 11:59:59'
                } else {
                    $('.tab-h2').children('div').eq(2).addClass('step-now').siblings('div').removeClass('step-now')
