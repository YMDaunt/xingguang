...
import $ from 'jquery'
import {getPackageId, getPlatformType, goRoom, goLogin} from 'common'
...
new Vue({
    ...
    methods: {
                ...
                axios.get('/springFestival2020/getRedPackage')
                    .then((res) => {
                        ...
                        if (data.errno === 0) {
                            ...
                            this.disapperTost(2500, '成功领取春节红包' + this.openVal + this.dwName + '，已下发至账户')
                            this.canOpen = false
                        } else {
                            this.disapperTost(2500, data.msg)
                        }
        ...
        // 去我和星光的2019
        goWithXg () {
            window.open('https://m.tuho.tv/dist/activity/new/withLive.html')
        },
