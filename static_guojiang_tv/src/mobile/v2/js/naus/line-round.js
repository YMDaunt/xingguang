function CanvasAnimate (Dom, options) {
    ...
    this.RoundColor = options.RoundColor || '#b8bcd2'
    this.RoundDiameter = options.RoundDiameter || 2
    this.LineColor = options.LineColor || '#4e5784'
    this.LineWeight = options.LineWeight || 0.5
...
var a = new CanvasAnimate(lr1, {length: 30, clicked: true, moveon: true})
a.Run()
